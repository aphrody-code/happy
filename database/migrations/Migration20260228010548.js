...
class Migration20260228010548 extends Migration {
  ...
  async up() {
    ...
    this.addSql(`create table \`fairy_tail_guilde\` (\`id\` integer not null primary key autoincrement, \`created_at\` datetime not null, \`updated_at\` datetime not null, \`discord_guild_id\` text not null, \`user_id\` text not null, \`guilde_id\` text not null, \`role_id\` text not null);`);
...
exports.Migration20260228010548 = Migration20260228010548;
